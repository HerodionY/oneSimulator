...
public abstract class MovementModelE{
	 ...
	 */
	public MovementModelE(Settings settings) {
		double[] speeds;
		double[] times;
	 ...
	 */
	public MovementModelE(MovementModelE mm) {
	 ...
	 */
	public abstract MovementModelE replicate();
